    ...
    <div class="container-fluid">
        ...
        <div class="menu-bar">
            <ul class="menu-bar-down">
                ...
                <li class="menu-item">
                    <a href="xoanguoidung.php" class="menu-item__link  active">XÓA NGƯỜI DÙNG</a>
                </li>
                <li class="menu-item">
        ...
        <form id="myform" name="myform" method="post">
	        ...
	        <input type="submit" class="snip1317" name="button" id="myBtn" value="Xóa" style="float: right;">
