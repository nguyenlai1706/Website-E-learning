            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                        ...
                        <ul class="sub-menu">
							...
							<li class="sub-item">
                                <a href="Source/city _admin/subjectmanagement.php" class="sub-link">QUẢN LÝ MÔN HỌC CỦA KHỐI LỚP</a>
                            </li>
                            <li class="sub-item">
				...
				<li class="menu-item-right">
                         <a class="menu-item-right__link" href="#">QUẢN TRỊ VIÊN CẤP TRƯỜNG</a>
							<ul class="sub-menu">
								...
								<li class="sub-item">
									<a href="./Source/school_admin/TDSL.php" class="sub-link">TAỌ DANH SÁCH LỚP</a>
								</li>
								<li class="sub-item">
									<a href="./Source/school_admin/viewLopHoc.php" class="sub-link">CẬP NHẬT DANH SÁCH LỚP</a>
								</li>
								<li class="sub-item">
									<a href="./Source/school_admin/xemLH.php" class="sub-link">THỐNG KÊ SỐ LIỆU</a>
								</li>
							</ul>
                </li>
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
						<li class="sub-item">
                            <a href="./Source/teacher/calendar.html" class="sub-link">LẬP KẾ HOẠCH THỜI GIAN BIỂU</a>
                        </li>
                        <li class="sub-item">
                        ...
                        <li class="sub-item">
                            <a href="Source/resultTest.php" class="sub-link">XEM THỐNG KÊ BÀI KIỂM TRA</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item-right">
                ...
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-item">
                            <a href="./Source/adminLogin.html" class="sub-link">QUẢN TRỊ VIÊN HỆ THỐNG</a>
                        </li>
                        <li class="sub-item">
                        <a href="./Source/teacherLogin.html" class="sub-link">GIÁO VIÊN</a>
                        </li>
                        <li class="sub-item">
                            <a href="./Source/studentLogin.html" class="sub-link">HỌC SINH</a>
                        </li>
                    </ul>
                </li>
