<?php 
	...
	if(isset($_SESSION['matk']) && isset($_SESSION['user']) && isset($_SESSION['pass'])) {
		...
		header('location: ../Source/GiaoVien/adminLogin.php');	
	}
        ...
        <div class="menu-bar">
            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-item">
                            <a href="Source/Giaovien/adminLogin.php" class="sub-link">QUẢN TRỊ VIÊN HỆ THỐNG</a>
                        </li>
                        <li class="sub-item">
                        <a href="Source/Giaovien/teacherLogin.php" class="sub-link">GIÁO VIÊN</a>
                        </li>
                        <li class="sub-item">
                            <a href="Source/Giaovien/studentLogin.php" class="sub-link">HỌC SINH</a>
                        </li>
                    </ul>
                </li>
