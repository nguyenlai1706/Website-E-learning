                            ...
                            <div class="modal-content subModal_content">
                                ...
                                <div class="modal-body">
                                    <div class="test-detail">
                                        BÀI KIỂM TRA 15 PHÚT <br><br>
                                        LỚP KIỂM TRA: <?php $p->loadMaLop("select malop from baikiemtra_tn order by malop asc LIMIT 1"); ?> <br><br>
                                        GIỜ BẮT ĐẦU KIỂM TRA: <?php $p->loadTimeStartExam("select thoigianbd_kt from baikiemtra_tn LIMIT 1"); ?> <br><br>
                                        GIỜ KẾT THÚC KIỂM TRA: <?php $p->loadTimeEndExam("select thoigiankt_kt from baikiemtra_tn LIMIT 1"); ?> <br><br>
                                        SỐ LẦN KIỂM TRA: <?php $p->loadTimesExam("select solankt from baikiemtra_tn LIMIT 1"); ?> <br><br>
                                        MÃ ĐỀ KIỂM TRA: <?php $p->loadCodeExam("select made from baikiemtra_tn LIMIT 1"); ?><br><br>
                                        MÃ MÔN KIỂM TRA: <?php $p->loadSubjectExam("select mamonhoc from baikiemtra_tn LIMIT 1"); ?>
                                    </div>
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger btn-close" data-dismiss="modal">ĐÓNG</button>  
                                    <a href="mainDoTestMulti.php">
