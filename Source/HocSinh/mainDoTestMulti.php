<?php 
	...
	if(isset($_SESSION['matk']) && isset($_SESSION['user']) && isset($_SESSION['pass'])) {
		...
		header('location: ../QTV_ThanhPho/adminLogin.php');	
	}
    ...
    <div class="container-fluid">
            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="sub-item">
                        <a href="doTest_Multi.php" class="sub-link">LÀM BÀI KIỂM TRA TRẮC NGHIỆM</a>
                        </li>
                        <li class="sub-item">
        ...
        <div class="content">
            ...
            <div class="doTest-content">
               ...
               <input class="btn btn-info" name="codeExam" value="<?php $p->loadCodeExam("select made from baikiemtra_tn LIMIT 1"); ?>"> 
               <label for="codeExam">MÃ LỚP</label>
              <input class="btn btn-info" name="codeClass" value="<?php $p->loadMaLop("select malop from baikiemtra_tn order by malop asc LIMIT 1"); ?>"> 				<label for="codeExam">MÃ HỌC SINH</label>
              <input class="btn btn-info" name="codeStudent" value="<?php $p->loadMaHocSinh("select mahocsinh from baikiemtra_tn order by malop asc LIMIT 1"); ?>">
                    <div class="form-group spacing">
                        ...
                        <div class="form-check-inline">
                            <label for="" class="form-check-label">
                                <input type="radio" name="answer1" id="answer1" class="form-check-input" value="<?php $p->loadAnswer2("select dapan2 from cauhoi_tn where macauhoi='C01K6TN'"); ?>"  >
                    ...
                    <div class="form-group spacing">
                        ...
                        <div class="form-check-inline">
                            <label for="" class="form-check-label">
                                <input type="radio" name="answer2" id="answer2" class="form-check-input" value="<?php $p->loadAnswer4("select dapan4 from cauhoi_tn where macauhoi='C02K6TN'"); ?>"  >
                    ...
                    <div class="form-group spacing">
                        ...
                        <div class="form-check-inline">
                            <label for="" class="form-check-label">
                                <input type="radio" name="answer3" id="answer3" class="form-check-input" value="<?php $p->loadAnswer4("select dapan4 from cauhoi_tn where macauhoi='C03K6TN'"); ?>"  >
                    ...
                    <div class="form-group spacing">
                        ...
                        <div class="form-check-inline">
                            <label for="" class="form-check-label">
                                <input type="radio" name="answer4" id="answer4" id="answer4" class="form-check-input" value="<?php $p->loadAnswer2("select dapan2 from cauhoi_tn where macauhoi='C04K6TN'"); ?>"  >
                    ...
                    <div class="form-group spacing">
                        ...
                        <div class="form-check-inline">
                            <label for="" class="form-check-label">
                                <input type="radio" name="answer5" id="answer5" class="form-check-input" value="<?php $p->loadAnswer2("select dapan2 from cauhoi_tn where macauhoi='C05K6TN'"); ?>"  >
							...
							switch($btn) {
								case 'NỘP BÀI': {
									...
									if(isset($_POST['answer1'])&&isset($_POST['answer2'])&&isset($_POST['answer3'])&&isset($_POST['answer4'])&&isset($_POST['answer4'])) {
                                        ...
                                        $made = $_POST['codeExam'];
										$malop = $_POST['codeClass'];
										$mahocsinh = $_POST['codeStudent'];
										...
										echo '<table border="1" class="table table-striped" id="tbl">
											...
											if($p->buildEssay("INSERT INTO ketqua_kiemtra(malop,mahocsinh,made,dapan1,dapan2,dapan3,dapan4,dapan5) 
VALUES ('$malop', '$mahocsinh', '$made', '$answer1', '$answer2', '$answer3', '$answer4','$answer5')")==1) {
												echo 'Nộp bài thành công!';
											}
											else {
												echo 'Nộp bài không thành công!';	
											}
