                ...
                <div class="login-form">
                    <div class="user-login">
                        <div class="input-form">
                            ...
                            <input type="text" class="input-user" name="username" id="username" placeholder="Nhập mã học sinh" required>
                        </div>
                    </div>
                    <div class="pass-login">
                        <div class="input-form">
                            <i class="fas fa-key"></i>&nbsp;&nbsp;
                            <input type="password" class="input-pass" name="password" id="password" placeholder="Nhập mật khẩu học sinh" required>
                        </div>
                    </div>
                    ...
                    <div class="other-login">
                        <div class="link-login">
                           <i><a class="link-student" href="../QTV_ThanhPho/adminLogin.php">Tôi là Quản trị viên TP</a></i> |
                           <i><a class="link-teacher" href="../GiaoVien/teacherLogin.php">Tôi là Giáo viên</a></i> |
                           <i><a class="link-student" href="./school_adminLogin.php">Tôi là QTV Trường</a></i>
                        </div>
                        <div class="back-page">
