        ...
        <div class="menu-bar">
            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-item">
                                <a href="./LMS_Khang/QuantrivienTP/lms/Source/QTCTP/QLDS_TP.php" class="sub-link">QUẢN LÝ DANH SÁCH CẤP TRƯỜNG</a>
                            </li>
                            <li class="sub-item">
                                <a href="./LMS_Khang/QuantrivienTP/themnguoidung.php" class="sub-link">THÊM NGƯỜI DÙNG</a>
                            </li>
                            <li class="sub-item">
                                <a href="./LMS_Khang/QuantrivienTP/xoanguoidung.php" class="sub-link">XOÁ NGƯỜI DÙNG</a>
                            </li>
                            <li class="sub-item">
                                <a href="./LMS_Khang/QuantrivienTP/suanguoidung.php" class="sub-link">SỬA NGƯỜI DÙNG</a>
                            </li>
                        </ul>
                </li>
