    ...
    <div class="container-fluid">
        ...
        <div class="website-header">
            <div class="website-name">
                <div class="website-name__main"><a href="LMS_Ly/Source/school_admin/teacher_delegation.php">PHÂN QUYỀN GIÁO VIÊN TỪNG LỚP</a>
            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                         <a class="menu-item-right__link" href="#">QUẢN TRỊ VIÊN CẤP TRƯỜNG</a>
							<ul class="sub-menu">
								<li class="sub-item">
									<a href="../LMS_TongHop/LMS_Ly/Source/school_admin/teacher_delegation.php" class="sub-link">PHÂN QUYỀN GIÁO VIÊN TỪNG LỚP</a>
								</li>
								<li class="sub-item">
