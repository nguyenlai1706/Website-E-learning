        ...
        <div class="menu-bar">
            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-item">
                            <a href="./Long/index.php?mod=users&action=score" class="sub-link">XEM ĐIỂM</a>
                        </li>
                        <li class="sub-item">
                        <a href="./Source/HocSinh/doTest_Multi.php" class="sub-link">LÀM BÀI KIỂM TRA TRẮC NGHIỆM</a>
                        </li>
                        <li class="sub-item">
                            <a href="#" class="sub-link">NỘP BÀI KIỂM TRA TỰ LUẬN</a>
                        </li>
                        <li class="sub-item">
                            <a href="./Source/HocSinh/xemthoigianbieu.php" class="sub-link">XEM THỜI GIAN BIỂU</a>
                        </li>
                    </ul>
                </li>
            </ul>
