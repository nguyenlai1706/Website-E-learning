            ...
            <ul class="menu-bar-option">
                <li class="menu-item-right">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="sub-item">
                            <a href="./LMS_Ngan/Source/GiaoVien/buildMultiChoice.php" class="sub-link">TẠO CÂU HỎI TRẮC NGHIỆM</a>
                        </li>
                        <li class="sub-item">
                            <a href="./LMS_Ngan/Source/GiaoVien/buildEssay.php" class="sub-link">TẠO CÂU HỎI TỰ LUẬN</a>
                        </li>
                        <li class="sub-item">
                            <a href="./LMS_Ngan/Source/LONG_BAOCAO/index.php" class="sub-link">TẠO ĐỀ KIỂM TRA</a>
                        </li>
                        <li class="sub-item">
                            <a href="./LMS_Ngan/Source/GiaoVien/viewStatistical.php" class="sub-link">XEM THỐNG KÊ BÀI KIỂM TRA</a>
                        </li>
                        <li class="sub-item">
                            <a href="./LMS_Ngan/Source/GiaoVien/DSlop.php" class="sub-link">NHẬP ĐIỂM</a>
                        </li>
                        <li class="sub-item">
                            <a href="Source/GiaoVien/viewStatistical.php" class="sub-link">XEM THỐNG KÊ BÀI KIỂM TRA</a>
                        </li>
                    </ul>
                </li>
            </ul>
